var MyBundle = (function (exports) {
  ...
  function requireLunr() {
    if (hasRequiredLunr) return lunr$1.exports;
    hasRequiredLunr = 1;
    ...
    })(lunr$1, lunr$1.exports);
    return lunr$1.exports;
  }

  var lunrExports = requireLunr();
  var lunr = /*@__PURE__*/ getDefaultExportFromCjs(lunrExports);

  const language = ["en", "zh"];
  const searchIndexUrl = "search-index{dir}.json?_=17628c66";
  const searchResultLimits = 100;
   ...
   */
  function cutZhWords(token, zhDictionary) {
    const wrappedTerms = [];
          ...
          SnowballProgram: function () {
            ...
            return {
              ...
              eq_s_b: function (s_size, s) {
                ...
                for (var i = 0; i < s_size; i++)
                  if (
                    current.charCodeAt(this.cursor - s_size + i) !=
                    s.charCodeAt(i)
                  )
                    return false;
                this.cursor -= s_size;
    ...
    (function (root, factory) {
      ...
      return function (lunr) {
        ...
        lunr.multiLanguage = function (/* lang1, lang2, ... */) {
          ...
          var multiTrimmer =
            lunr.trimmerSupport.generateTrimmer(wordCharacters);
   ...
   * @returns A smart term list.
   */
  function smartTerms(tokens, zhDictionary) {
   ...
   */
  function smartQueries(tokens, zhDictionary) {
  ...
  function processTreeStatusOfSearchResults(results) {
